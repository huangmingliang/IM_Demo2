...
import com.example.demo_im.model.FileMessage;
...
import com.example.demo_im.model.VideoMessage;
import com.example.demo_im.model.VoiceMessage;
import com.example.demo_im.utils.FileUtil;
import com.example.demo_im.utils.MediaUtil;
import com.example.demo_im.utils.RecorderUtil;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                for (String id:ids){
                    ChatPresenter forwardPresenter = new ChatPresenter(this, id, TIMConversationType.C2C);
                    TIMMessage timMessage = new TIMMessage();
                    boolean isCopySuc = timMessage.copyFrom(sMessage.getMessage());
                    if (isCopySuc) {
                        forwardPresenter.sendMessage(timMessage);
                    }
                }
